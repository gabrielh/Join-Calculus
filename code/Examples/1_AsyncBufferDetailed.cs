...
namespace ZsK.Joins.AsyncBufferDetailed {
    ...
    public static class Example {
        ...
        public static void Demo() {
            ...
            var th1 = new Thread(() => {
                ...
                buffer.Put(1);
                Log.Trace("...done, Put queue:[1]");
                Thread.Sleep(200);
                Log.Trace("Slept for 200 ms");
                Log.Trace("Putting 4..., Put queue:[]");
                buffer.Put(4);
                Log.Trace("...done, Put queue:[4]");
                Log.MergeTrace();
            });
            var th2 = new Thread(() => {
                Log.Trace("thread 2");
                Thread.Sleep(20);
                Log.Trace("Putting 2..., Put queue:[1]");
                buffer.Put(2);
                Log.Trace("...done, Put queue:[2,1]");
                Thread.Sleep(150);
                Log.Trace("Slept for 200 ms");
                Log.Trace("Putting 3..., Put queue:[]");
                buffer.Put(3);
                Log.Trace("...done, Put queue:[3]");
